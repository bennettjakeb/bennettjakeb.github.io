...
weatherObject.onload = function() {
    ...
    document.getElementById('place1').innerHTML = weatherInfo.name;
    document.getElementById('currentTemp1').innerHTML = weatherInfo.main.temp;
    document.getElementById('currentWind1').innerHTML = weatherInfo.wind.speed;
    document.getElementById('humid1').innerHTML = weatherInfo.main.humidity;
    document.getElementById('currently1').innerHTML = weatherInfo.weather[0].description;
